...
export const LEGACY_URLS = [
  ...
  { url: '/custom-concrete-driveways/',                                title: 'Custom Concrete Driveways',       built: false },
  { url: '/concrete-countertops/',                                     title: 'Concrete Countertops',            built: false },
  { url: '/masonry/',                                                  title: 'Masonry',                         built: true  },
  { url: '/stonework/',                                                title: 'Stonework',                       built: false },
  { url: '/fireplaces-and-barbecues/',                                 title: 'Outdoor Kitchens and Fireplaces', built: true  },
  { url: '/grading-and-excavation/',                                   title: 'Grading and Excavation',          built: false },
  { url: '/featured-work/',                                            title: 'Featured Work',                   built: true  },
  { url: '/featured-project-dos-vientos-villa/',                       title: 'Dos Vientos Villa',               built: false },
